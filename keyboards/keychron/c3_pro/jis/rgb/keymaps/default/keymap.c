...
#define KC_CRTA LGUI(KC_C)
#define KC_SNAP LSG_T(KC_C)
#define FN_MAC MO(MAC_FN)
#define FN_WIN MO(WIN_FN)

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_tkl_jis(
        KC_ESC,             KC_BRID,  KC_BRIU,  KC_MICT,  KC_LAPA,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,            KC_SNAP,  _______,  RGB_MOD,
        ...
        KC_LCTL,  KC_LOPT,  KC_LCMD, KC_LNG2,                      KC_SPC,                        KC_LNG1,  KC_RCMD,  KC_ROPT,  FN_MAC,   KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),

    [MAC_FN] = LAYOUT_tkl_jis(
        ...
        KC_OSSW,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
